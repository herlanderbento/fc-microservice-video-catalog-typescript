...
export class CategoryFixture {
  public static keysInResponse() {
    return ['id', 'name', 'description', 'is_active', 'created_at'];
  }

  public static arrangeForSave() {
  ...
  public static arrangeInvalidRequest() {
  ...
  public static arrangeForEntityValidationError() {
    const faker = Category.fake().aCategory();
    const defaultExpected = {
      statusCode: 422,
      error: 'Unprocessable Entity',
...
export class ListCategoriesFixture {
  public static arrangeIncrementedWithCreatedAt() {
